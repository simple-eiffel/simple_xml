...
feature -- Initialization
	...
	make
		...
		do
			...
			run_test (agent l_tests.test_quick_xpath, "test_quick_xpath")
			run_test (agent l_tests.test_quick_first, "test_quick_first")
			...
			run_test (agent l_tests.test_serializer_basic, "test_serializer_basic")
			run_test (agent l_tests.test_serializer_settings, "test_serializer_settings")
			print ("%N=============================%N")
